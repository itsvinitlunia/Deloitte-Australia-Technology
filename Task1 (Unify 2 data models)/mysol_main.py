...
def convertFromFormat1(jsonObject):
    ...
    #Splitting the string on terms of "/" to extract location data

    return {
        #Mapping of deviceID, deviceType, timestamp, location and data
...
def convertFromFormat2(jsonObject):
    ...
    #This used ISO 8601 therefore first we parse UTC be replacing Z and then convert to milliseconds
